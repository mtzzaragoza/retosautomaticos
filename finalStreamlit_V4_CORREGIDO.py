...
def extraer_respuestas_desde_doc(doc):
    ...
    VERSIÓN V3 CORREGIDA: NO filtra respuestas que coincidan con conjuntos base.
    El filtrado de conjuntos base solo se aplica en contextos específicos (definiciones).
    """
    respuestas = []
        ...
        for row in table.rows:
            for cell in row.cells:
                ...
                if tiene_resultado or tiene_operacion or solo_conjunto:
                    ...
                    # Buscar con TODOS los delimitadores
                    # Corchetes []
...
def extraer_conjunto_agresivo(texto):
    """
    VERSIÓN ULTRA MEJORADA: Extrae conjuntos de CUALQUIER formato.
    Detecta: [], {}, (), números con espacios, y toma el ÚLTIMO conjunto válido.
    NUEVO: Maneja múltiples signos "=" y toma el resultado después del último.
    """
    todos_conjuntos = []
...
def mostrar_r3md():
    ...
    st.success("✨ **VERSIÓN V4 ULTRA MEJORADA** - Detección completa de incisos en formato numérico (1-7) y alfabético (a-g)")
    
    with st.expander("📋 Información de esta versión"):
        st.markdown("""
        **🎯 Versión V4 - Mejora Ultra en Detección de PDF:**
        
        **🔧 NUEVAS MEJORAS EN V4:**
        ...
        - 🎯 **Ejemplo real resuelto:** Detecta correctamente el formato del PDF de ejemplo (TESTINGR3.pdf)
        ...
        **📊 Comparativa de versiones:**
        ...
        - **V4: Detección universal (números Y letras), respuestas separadas (~98%)** ← Actual
        """)
